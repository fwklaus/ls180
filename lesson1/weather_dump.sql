...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: fwklaus
--
...
ALTER TABLE public.weather OWNER TO fwklaus;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: fwklaus
--
